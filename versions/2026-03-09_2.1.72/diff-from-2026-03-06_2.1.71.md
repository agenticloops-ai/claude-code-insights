...
| tool_count | 1 | 1 |
| deferred_tool_count | 24 | 25 |
| system_prompt_chars | 15641 | 15644 |
| reminder_count | 2 | 2 |
...
- **added to deferred (via ToolSearch):** `ExitWorktree`
- **modified:** `ToolSearch`

<details><summary>full tool list — 2.1.72: 1 advertised + 25 deferred</summary>
