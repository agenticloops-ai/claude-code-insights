...
- **added to deferred (via ToolSearch):** `CronCreate`, `CronDelete`, `CronList`

<details><summary>full tool list — 2.1.71: 1 advertised + 24 deferred</summary>
