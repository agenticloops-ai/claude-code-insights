# claude-code: 2.1.52 → 2.1.53

| metric | 2.1.52 | 2.1.53 |
|---|---|---|
| models | claude-opus-4-6 | claude-opus-4-6 |
| tool_count | 21 | 21 |
| deferred_tool_count | 0 | 0 |
| system_prompt_chars | 14755 | 15218 |
| reminder_count | 2 | 2 |
...
- **modified:** `Bash`, `Task`, `Write`

<details><summary>full tool list — 2.1.53: 21 advertised + 0 deferred</summary>
