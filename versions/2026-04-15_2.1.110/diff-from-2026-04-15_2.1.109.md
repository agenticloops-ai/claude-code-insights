# claude-code: 2.1.109 → 2.1.110

| metric | 2.1.109 | 2.1.110 |
|---|---|---|
| models | claude-opus-4-6 | claude-opus-4-6 |
| tool_count | 10 | 10 |
| deferred_tool_count | 0 | 19 |
| system_prompt_chars | 26300 | 26300 |
| reminder_count | 3 | 4 |

## tools

- **added:** `AskUserQuestion`, `CronCreate`, `CronDelete`, `CronList`, `EnterPlanMode`, `EnterWorktree`, `ExitPlanMode`, `ExitWorktree`, `ListMcpResourcesTool`, `Monitor`, `NotebookEdit`, `PushNotification`, `ReadMcpResourceTool`, `RemoteTrigger`, `TaskOutput`, `TaskStop`, `TodoWrite`, `WebFetch`, `WebSearch`
- **new deferred tools:** `AskUserQuestion`, `CronCreate`, `CronDelete`, `CronList`, `EnterPlanMode`, `EnterWorktree`, `ExitPlanMode`, `ExitWorktree`, `ListMcpResourcesTool`, `Monitor`, `NotebookEdit`, `PushNotification`, `ReadMcpResourceTool`, `RemoteTrigger`, `TaskOutput`, `TaskStop`, `TodoWrite`, `WebFetch`, `WebSearch`
- **modified:** `ToolSearch`

## skills

- **removed:** `insights`, `statusline`, `team-onboarding`
