...
| tool_count | 10 | 10 |
| deferred_tool_count | 19 | 20 |
| system_prompt_chars | 26300 | 26300 |
| reminder_count | 2 | 3 |

## tools

| count | 2.1.109 | 2.1.110 |
|---|---|---|
| advertised | 10 | 10 |
| deferred | 19 | 20 (+1) |
| **total** | **29** | **30** (+1) |

- **added to deferred (via ToolSearch):** `PushNotification`
- **modified:** `ToolSearch`

<details><summary>full tool list — 2.1.110: 10 advertised + 20 deferred</summary>
