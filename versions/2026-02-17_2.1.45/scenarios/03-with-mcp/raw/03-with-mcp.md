...
**Started:** 2026-05-04T17:40:23.189471  
**Ended:** 2026-05-04T17:40:57.666395  
**Requests:** 2  
...
## Request #1 — claude-haiku-4-5-20251001 (anthropic) — 571ms
...
```
x-anthropic-billing-header: cc_version=2.1.45.3c3; cc_entrypoint=sdk-cli; cch=00000;
...
That's 83 MCP tools total across 9 servers (fixture, Google Calendar, Gmail, Excalidraw, Canva, Google Drive, Figma, tldraw, Mermaid Chart).
```

*Tokens: 3 in / 1,531 out (1,534 total) — Cost: $0.6202*
