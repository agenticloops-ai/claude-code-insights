...
```
x-anthropic-billing-header: cc_version=2.1.19.122; cc_entrypoint=sdk-cli
...
| `allowed_tools` | array | no | Tools to grant this agent. User will be prompted to approve if not already allowed. Example: ["Bash(git commit*)", "Read"] |
...
```
I need to search for the available MCP tools to list them for you.
```
...
*Tokens: 2 in / 90 out (92 total) — Cost: $0.4259*
