...
**Started:** 2026-05-03T08:17:30.780908  
**Ended:** 2026-05-03T08:17:53.561245  
**Requests:** 6  
**Tokens:** 584 (in: 15 / out: 569)  
**Cost:** $0.0837  
...
## Request #1 — claude-3-5-haiku-20241022 (anthropic) — 189ms
...
## Request #2 — claude-sonnet-4-5-20250929 (anthropic) — 2.3s
...
```tool_call: Bash
{
  "command": "npm view claude-code version",
  "description": "Get latest claude-code version from npm"
}
```

*Tokens: 2 in / 81 out (83 total) — Cost: $0.0559*

---

## Request #3 — claude-3-5-haiku-20241022 (anthropic) — 166ms
...
## Request #4 — claude-sonnet-4-5-20250929 (anthropic) — 1.5s
...
> **Tool Result** (id: toolu_013HB2DiNntdYFKMgavNvofy)
...
```tool_call: WebSearch
{
  "query": "claude-code npm latest version 2025"
}
```

*Tokens: 6 in / 60 out (66 total) — Cost: $0.0057*

---

## Request #5 — claude-sonnet-4-5-20250929 (anthropic) — 10.3s
...
```
Perform a web search for the query: claude-code npm latest version 2025
```

**Assistant:**

```
Based on the search results, I can provide you with information about the latest version of claude-code on npm:
...
```
The latest version of @anthropic-ai/claude-code is **2.1.120**, last published 2 hours ago
```

```
 (as of the search results from May 3, 2026).

## Important Notes

1. **Official Package Name**: The official Claude Code npm package is 
```
...
```
. There's also a package called "claude-code" (without the @anthropic-ai scope), but 
```

```
that package is at version 1.0.0, published 7 months ago, and it explicitly states it's not the official package
```

```
.

2. **npm Installation Deprecated**: It's worth noting that 
```

```
installation via npm is deprecated, and the recommended methods should be used instead
```

```
. The current recommended installation methods include native installers, Homebrew, and WinGet.

3. **Installation Command**: If you still want to use npm, the correct command is:
   ```
   npm install -g @anthropic-ai/claude-code
   ```

The package receives frequent updates, with the current version (2.1.120) being just 2 hours old at the time of the search, indicating active development and maintenance.
```

*Tokens: 3 in / 420 out (423 total) — Cost: $0.0148*

---

## Request #6 — claude-sonnet-4-5-20250929 (anthropic) — 1.3s
...
> **Tool Result** (id: toolu_01XeG19c44UDhq9hiMduXpf3)
> Web search results for query: "claude-code npm latest version 2025"
> 
> Links: [{"title":"@anthropic-ai/claude-code - npm","url":"https://www.npmjs.com/package/@anthropic-ai/claude-code"},{"title":"claude-code/CHANGELOG.md at main · anthropics/claude-code","url":"https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md"},{"title":"Claude Code - Overview - Z.AI DEVELOPER DOCUMENT","url":"https://docs.z.ai/devpack/tool/claude"},{"title":"Claude Code overview - Claude Code Docs","url":"https://code.claude.com/docs/en/overview"},{"title":"Claude Code by Anthropic | AI Coding Agent, Terminal, IDE","url":"https://claude.com/product/claude-code"},{"title":"claude-code - npm","url":"https://www.npmjs.com/package/claude-code"},{"title":"@anthropic-ai/claude-agent-sdk - npm","url":"https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk"},{"title":"How to install Claude Code: npm, brew, and setup (2026) | eesel AI","url":"https://www.eesel.ai/blog/npm-install-claude-code"},{"title":"GitHub - anthropics/claude-code: Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands. · GitHub","url":"https://github.com/anthropics/claude-code"},{"title":"Claude Code Changelog: All Release Notes (2026)","url":"https://claudefa.st/blog/guide/changelog"}]
> 
> Based on the search results, I can provide you with information about the latest version of claude-code on npm:
> 
> ## Latest Version
> 
> The latest version of @anthropic-ai/claude-code is **2.1.120**, last published 2 hours ago (as of the search results from May 3, 2026).
> 
> ## Important Notes
> 
> 1. **Official Package Name**: The official Claude Code npm package is **@anthropic-ai/claude-code**. There's also a package called "claude-code" (without the @anthropic-ai scope), but that package is at version 1.0.0, published 7 months ago, and it explicitly states it's not the official package.
> 
> 2. **npm Installation Deprecated**: It's worth noting that installation via npm is deprecated, and the recommended methods should be used instead. The current recommended installation methods include native installers, Homebrew, and WinGet.
> 
> 3. **Installation Command**: If you still want to use npm, the correct command is:
>    ```
>    npm install -g @anthropic-ai/claude-code
...
*Tokens: 4 in / 8 out (12 total) — Cost: $0.0074*
