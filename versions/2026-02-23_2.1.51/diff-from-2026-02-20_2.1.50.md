...
- **removed:** `AskUserQuestion`, `EnterPlanMode`, `EnterWorktree`, `ExitPlanMode`, `ListMcpResourcesTool`, `NotebookEdit`, `ReadMcpResourceTool`, `SendMessage`, `Skill`, `TaskOutput`, `TaskStop`, `TeamCreate`, `TeamDelete`, `TodoWrite`, `WebFetch`, `WebSearch`
- **modified:** `ToolSearch`

<details><summary>full tool list — 2.1.51: 8 advertised + 0 deferred</summary>
