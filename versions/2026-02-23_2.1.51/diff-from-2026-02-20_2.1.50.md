...
- **removed:** `AskUserQuestion`, `EnterPlanMode`, `EnterWorktree`, `ExitPlanMode`, `ListMcpResourcesTool`, `NotebookEdit`, `ReadMcpResourceTool`, `Skill`, `TaskOutput`, `TaskStop`, `TodoWrite`, `WebFetch`, `WebSearch`
- **modified:** `ToolSearch`
