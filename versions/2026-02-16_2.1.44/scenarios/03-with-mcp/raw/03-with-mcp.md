...
**Started:** 2026-05-04T08:20:32.617269  
**Ended:** 2026-05-04T08:21:02.509175  
**Requests:** 2  
...
## Request #1 — claude-haiku-4-5-20251001 (anthropic) — 867ms
...
```
x-anthropic-billing-header: cc_version=2.1.44.dad; cc_entrypoint=sdk-cli; cch=00000;
...
That's 88 MCP tools total across the fixture, Canva, Gmail, Google Drive, Google Calendar, Excalidraw, tldraw, Mermaid Chart, and Figma servers.
```

*Tokens: 3 in / 1,531 out (1,534 total) — Cost: $0.5447*
