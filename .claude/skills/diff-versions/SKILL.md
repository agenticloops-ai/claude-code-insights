...
The local-mode CLI scenario (`01-cli-help`) also gets diffed: parsed added/removed flags + commands, plus the raw unified diff inside a collapsed `<details>` block.
